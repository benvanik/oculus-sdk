...
Filename    :   OVR_MacOS_HMDDevice.cpp
Content     :   MacOS Interface to HMD - detects HMD display
...
HMDDeviceCreateDesc::HMDDeviceCreateDesc(const HMDDeviceCreateDesc& other)
        : DeviceCreateDesc(other.pFactory, Device_HMD),
          ...
          DesktopX(other.DesktopX), DesktopY(other.DesktopY),
